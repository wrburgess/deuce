...
| 1 — Lifecycle & skills | The stages every piece of work passes through, and the procedures that run them | `not started` | [#3](https://github.com/wrburgess/deuce/issues/3) |
