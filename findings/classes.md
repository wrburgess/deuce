...
5 instances, across 4 pull requests — PR #39, PR #41, PR #45, PR #46.
...
3 instances, across 2 pull requests — PR #41, PR #43.
...
2 instances, across 2 pull requests — PR #43, PR #45.
